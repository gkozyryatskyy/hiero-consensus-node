...
public class HbarAllowanceTranslatorTest extends CallAttemptTestBase {
    ...
    void matchesHbarAllowance() {
        ...
        attempt = createHasCallAttempt(
                TestHelpers.bytesForRedirectAccount(HBAR_ALLOWANCE.selector(), NON_SYSTEM_LONG_ZERO_ADDRESS),
                subject
        );
        // then
    ...
    void failsOnInvalidSelector() {
        ...
        // when
        attempt = createHasCallAttempt(
                TestHelpers.bytesForRedirectAccount(HBAR_APPROVE.selector(), NON_SYSTEM_LONG_ZERO_ADDRESS),
                subject
        );
        // then
